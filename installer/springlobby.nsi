...
!define PRODUCT_WEB_SITE "https://springlobby.springrts.com"
...
!define MUI_FINISHPAGE_SHOWREADME "https://github.com/springlobby/springlobby/wiki/Userdoc"
...
InstallDir "$PROGRAMFILES\SpringLobby"
...
!ifndef SPRINGLOBBY_ARCHIVE
	!error "SPRINGLOBBY_ARCHIVE undefined: please specifiy the path of the springlobby zip archive"
!else
	${!echonow} "Using SPRINGLOBBY_ARCHIVE: ${MIN_PORTABLE_ARCHIVE}"
!endif
...
Section -Post
	...
	${IfNot} ${SectionIsSelected} ${SEC_PORTABLE}
		...
		${If} $REGISTRY = 1
			WriteRegStr ${PRODUCT_ROOT_KEY} "${PRODUCT_DIR_REGKEY}" "@" "$INSTDIR\springlobby.exe"
			WriteRegStr ${PRODUCT_ROOT_KEY} "${PRODUCT_DIR_REGKEY}" "Path" "$INSTDIR"
			WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
			WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
			WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\springlobby.exe"
