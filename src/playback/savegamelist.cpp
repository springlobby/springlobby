...
bool SavegameList::GetSavegameInfos ( const wxString& SavegamePath, Savegame& ret )
{
    ...
    GetHeaderInfo( ret, SavegamePath );
...
void SavegameList::GetScriptFromSavegame ( const wxString& SavegamePath, wxString& script  )
{
    try
    {
        wxFile replay( SavegamePath, wxFile::read );
        replay.Seek( 20 );
        int headerSize=0 ;
...
void SavegameList::GetBattleFromScript( const wxString& script_, OfflineBattle& battle, bool loadmod )
{
...
void SavegameList::LoadMMOpts( const wxString& sectionname, OfflineBattle& battle, const PDataList& node )
{
...
void SavegameList::LoadMMOpts( OfflineBattle& battle, const PDataList& node )
{
    OptionsWrapper& opts = battle.CustomBattleOptions();
...
void SavegameList::GetHeaderInfo( Savegame& rep, const wxString& SavegamePath )
{
    try
    {
        wxFile replay( SavegamePath, wxFile::read );
