...
wxJSONValue&
    wxJSONValue::
    operator=(const wxMemoryBuffer& buff)
{
...
wxJSONValue&
    wxJSONValue::
    operator=(const wxJSONValue& other)
{
	Ref(other);
	return *this;
}
