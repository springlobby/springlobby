...
m_command_alias[_T("€")] = _T("REMOVEBOT");
m_command_alias[_T("")] = _T("UPDATEBOT");
m_command_alias[_T("‚")] = _T("UPDATEBOT");
m_command_alias[_T("ƒ")] = _T("ADDSTARTRECT");
m_command_alias[_T("„")] = _T("ADDSTARTRECT");
m_command_alias[_T("…")] = _T("REMOVESTARTRECT");
m_command_alias[_T("†")] = _T("REMOVESTARTRECT");
m_command_alias[_T("‡")] = _T("MAPGRADES");
m_command_alias[_T("ˆ")] = _T("MAPGRADES");
m_command_alias[_T("‰")] = _T("MAPGRADESFAILED");
m_command_alias[_T("Š")] = _T("SCRIPTSTART");
m_command_alias[_T("‹")] = _T("SCRIPTSTART");
m_command_alias[_T("Œ")] = _T("SCRIPT");
m_command_alias[_T("")] = _T("SCRIPT");
m_command_alias[_T("Ž")] = _T("SCRIPTEND");
m_command_alias[_T("")] = _T("SCRIPTEND");
