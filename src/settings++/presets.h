...
const int vl_MaxParticles[3] = 			{ 100,		6000,	20000	};
...
const presetValues<int, 3> pr_MaxNanoParticles = presetValues<int, 3>(_T("MaxParticles"),levels_low_To_High,vl_MaxParticles);
