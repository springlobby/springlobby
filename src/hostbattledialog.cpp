...
{
  if ( m_rank0_radio->GetValue() ) return 1;
  if ( m_rank1_radio->GetValue() ) return 2;
  if ( m_rank2_radio->GetValue() ) return 3;
  if ( m_rank3_radio->GetValue() ) return 4;
  if ( m_rank4_radio->GetValue() ) return 5;
  if ( m_rank5_radio->GetValue() ) return 6;
  if ( m_rank6_radio->GetValue() ) return 7;
  return 000;
}
