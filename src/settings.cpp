...
wxString Settings::GetSpringPathInSameBundle()
{
...
{
	if ( IsPortableMode() )
        return GetCurrentUsedDataDir() + sep + _T( "springsettings.cfg" );
	else
...
{
    #if defined(__WXMSW__)
        wxString def = wxGetOSDirectory() + sep + _T("system32") + sep + _T("notepad.exe");
