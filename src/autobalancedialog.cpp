...
const long AutoBalanceDialog::ID_CLANS = wxNewId();
const long AutoBalanceDialog::ID_STRONG_CLANS = wxNewId();
...
AutoBalanceDialog::AutoBalanceDialog(wxWindow* parent)
{
  /// this is autogenerated code, do not edit.
	...
	m_choices_sizer->Add(m_method_choice, 0, wxALL|wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL, 0);
	m_main_sizer->Add(m_choices_sizer, 0, wxALL|wxALIGN_CENTER_HORIZONTAL|wxALIGN_CENTER_VERTICAL, 5);
	m_clans_choice = new wxCheckBox(this, ID_CLANS, _("Put clan members together"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_CLANS"));
	m_clans_choice->SetValue(true);
	m_main_sizer->Add(m_clans_choice, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
	m_strong_clans_choice = new wxCheckBox(this, ID_STRONG_CLANS, _("Allow too strong clans"), wxDefaultPosition, wxDefaultSize, 0, wxDefaultValidator, _T("ID_STRONG_CLANS"));
	m_strong_clans_choice->SetValue(true);
	m_main_sizer->Add(m_strong_clans_choice, 0, wxALL|wxALIGN_LEFT|wxALIGN_CENTER_VERTICAL, 5);
  ...
  /// end of autogenerated code.
	m_method_choice->SetSelection(sett().GetBalanceMethod());
	m_clans_choice->SetValue(sett().GetBalanceClans());
	m_strong_clans_choice->SetValue(sett().GetBalanceStrongClans());
}
...
{
  sett().SetBalanceMethod(m_method_choice->GetSelection());
  sett().SetBalanceClans(m_clans_choice->GetValue());
  sett().SetBalanceStrongClans(m_strong_clans_choice->GetValue());
  EndModal( wxID_OK );
}
