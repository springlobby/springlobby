...
AutoBalanceDialog::AutoBalanceDialog(wxWindow* parent)
{
  ...
  /// end of autogenerated code.
	...
	m_clans_choice->SetSelection(sett().GetBalanceClans()+(sett().GetBalanceClans()&&sett().GetBalanceStrongClans()));
}
...
void AutoBalanceDialog::OnOk(wxCommandEvent& event)
{
  ...
  sett().SetBalanceClans(m_clans_choice->GetSelection()>0);
  sett().SetBalanceStrongClans(m_clans_choice->GetSelection()>1);
  EndModal( wxID_OK );
}
