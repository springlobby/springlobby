...
class Settings
{
   ...
   */
     ...
     *
     * Color names should be in @c Namecase or @c CamelCase, or (if
     * applicable) @c TLAC (Three-Letter Acronym Case ;)
     *
     *     * If the named color exists in the user's configuration,
     *       that value will be used.
     *
     *     * If the named color does not exist in the user's
     *       configuration, an attempt will be made to look up a
     *       predefined default for that color.
     *
     *     * If the color still has not been found, a non-fatal error
     *       message will be logged and a generic color (likely unfit
     *       for the intended purpose) will be used.
     *
     *
     ...
     *
     * If the color's name cannot be found in the list of predefined
     * colors, a non-fatal error message will be logged.
     *
     */
    wxColour SetChatColor(const wxString& name, const wxColour& color);
