...
#define wxADD_KEYBINDER_SUPPORT()                       \
	virtual bool MSWShouldPreProcessMessage(WXMSG*) \
	{                                               \
		return FALSE;                           \
	}
#else
...
public:
	...
	wxKeyBinder(const wxKeyBinder& tocopy)
	    : wxObject(tocopy)
	{
		DeepCopy(tocopy);
	}
...
public: // miscellaneous
	...
	wxArrayPtrVoid* GetHandlersArr()
	{
		return &m_arrHandlers;
	}
...
public: // miscellaneous
	...
	{
		return m_notDeletable;
	}
	bool IsNotEditable() const
	{
		return m_notEditable;
	}
...
public:
	...
	const wxKeyProfile* Item(unsigned n) const
	{
		return (wxKeyProfile*)m_arr.Item(n);
	}
