...
//-----------------------------------------------------------------------------
//namespace SL_Extern {
IMPLEMENT_DYNAMIC_CLASS(SL_JPEGHandler,wxImageHandler)
...
bool SL_JPEGHandler::LoadFile( wxImage *image, wxInputStream& stream, bool verbose, int WXUNUSED(index) )
{
...
bool SL_JPEGHandler::SaveFile( wxImage *image, wxOutputStream& stream, bool verbose )
{
...
bool SL_JPEGHandler::DoCanRead( wxInputStream& stream )
{
    unsigned char hdr[2];
