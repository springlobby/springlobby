...
public:
	...
	LPTSTR AllocateString(size_t n)
	{
		return new TCHAR[n];
	}
	...
	LONG32 ShowNotification(LPCSTR Class, LPCSTR Title, LPCSTR Text, LONG32 Timeout = 0, LPCSTR Icon = NULL, HWND hWndReply = NULL, LONG32 uReplyMsg = 0, LPCSTR Sound = NULL);
	LONG32 ShowNotification(LPCWSTR Class, LPCWSTR Title, LPCWSTR Text, LONG32 Timeout = 0, LPCWSTR Icon = NULL, HWND hWndReply = NULL, LONG32 uReplyMsg = 0, LPCWSTR Sound = NULL);
	M_RESULT UnregisterApp();

	LONG32 GetLastMessageId()
	{
