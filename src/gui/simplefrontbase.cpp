...
SimpleFrontBase::SimpleFrontBase( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_skip = new wxCheckBox( this, wxID_ANY, _("Skip this screen next time"), wxDefaultPosition, wxDefaultSize, 0 );
	
	bSizer2->Add( m_skip, 0, wxALL, 5 );
	...
	m_skip->Connect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( SimpleFrontBase::OnSkipChecked ), NULL, this );
}
...
SimpleFrontBase::~SimpleFrontBase()
{
	...
	m_skip->Disconnect( wxEVT_COMMAND_CHECKBOX_CLICKED, wxCommandEventHandler( SimpleFrontBase::OnSkipChecked ), NULL, this );
}
