...
bool TorrentWrapper::JoinTorrent( const wxString& hash )
{
  ...
  if ( !wxFileName::IsFileReadable( sett().GetSpringDir() + wxFileName::GetPathSeparator() + _T("torrents")  + wxFileName::GetPathSeparator() + hash + _T(".torrent") ) ) /// file descriptor not present, download it
  {
